...
const char* mqttServer = "9f59300ce4.st1.iotda-device.cn-north-4.myhuaweicloud.com";
const int   mqttPort = 1883;
//以下3个参数可以由HMACSHA256算法生成，为硬件通过MQTT协议接入华为云IoT平台的鉴权依据
const char* clientId = "67ffc6ed84adf27cda4fa98b_lmn398ihnr_0_0_2025081508";
const char* mqttUser = "67ffc6ed84adf27cda4fa98b_lmn398ihnr";
const char* mqttPassword = "5be21deca35e20b968b7920fbc2e981ac82abbac06620ebcd976f5e6ba542b18";
